...
const sideBarListItem = {
      ...
      secondtItems:[
        {name: 'Manage Games', icon: <SportsEsportsIcon />, path: '/admin/games'},
        {name: 'Manage Bets', icon: <FeaturedPlayListIcon />, path: '/admin/bets'},
        {name: 'Manage Payments', icon: <PaidIcon />, path: '/admin/payments'},
      ],
