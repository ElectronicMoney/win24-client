...
const sideBarListItem = {
      ...
      secondtItems:[
        {name: 'Manage Games', icon: <SportsEsportsIcon />, path: '/admins/games'},
        {name: 'Manage Bets', icon: <FeaturedPlayListIcon />, path: '/admins/bets'},
        {name: 'Manage Payments', icon: <PaidIcon />, path: '/admins/payments'},
      ],
